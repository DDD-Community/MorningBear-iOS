...
public class SearchArticleQuery: GraphQLQuery {
  ...
  public static let document: ApolloAPI.DocumentType = .notPersisted(
    definition: .init(
      """
      query SearchArticle($size: Int) {
        searchArticle(sizeInput: $size) {
          __typename
          title
          link
          description
  ...
  public init(size: GraphQLNullable<Int>) {
    self.size = size
  }

  public var __variables: Variables? { ["size": size] }
  ...
  public struct Data: MorningBearAPI.SelectionSet {
    ...
    public static var __selections: [Selection] { [
      .field("searchArticle", [SearchArticle?]?.self, arguments: ["sizeInput": .variable("size")]),
    ] }
