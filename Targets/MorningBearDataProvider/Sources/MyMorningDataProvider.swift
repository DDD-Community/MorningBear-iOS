...
public struct MyMorningDataProvider: DataProviding {
    public func fetch() -> Single<[RecentMorning]> {
        return fetch(MyMorningQuery())
    }
    
    public func fetch(_ model: MyMorningQuery) -> Single<[RecentMorning]> {
